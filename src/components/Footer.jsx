        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div>
            ...
            <p className="text-gray-600 text-sm mb-4">
              Want to add your community's celebration to this list? 
              We'd love to help connect more devotees.
            </p>
            <p className="text-sm text-marigold-600 font-medium">
              Community-curated with ❤️
            </p>
          </div>
        </div>
          ...
          <div className="flex flex-col sm:flex-row justify-between items-center space-y-4 sm:space-y-0">
            <div className="flex items-center space-x-3">
              ...
              <div>
                ...
                <p className="text-xs text-gray-600">Community Celebrations Platform</p>
              </div>
            </div>
