...
import { Heart, Sun, Sunset, Sunrise, Clock } from "lucide-react";
              ...
              <div className="mt-4">
                <div className="group relative inline-flex items-center space-x-2 px-3 py-1.5 bg-marigold-500 hover:bg-marigold-600 text-white text-xs rounded-full transition-colors duration-200">
                  ...
                  <div className="absolute bottom-full mb-2 left-1/2 transform -translate-x-1/2 bg-gray-900 text-white text-xs px-2 py-1 rounded opacity-0 group-hover:opacity-100 transition-opacity duration-200 whitespace-nowrap pointer-events-none z-50">
                    <span className="hidden sm:inline">Chhath Puja 2025 ended on October 28, 2025</span>
          ...
          <div>
            ...
            <div className="flex items-center space-x-2">
              ...
              >
                ...
                <div className="absolute bottom-full mb-2 left-1/2 transform -translate-x-1/2 bg-gray-900 text-white text-xs px-2 py-1 rounded opacity-0 group-hover:opacity-100 transition-opacity duration-200 whitespace-nowrap pointer-events-none z-50">
                  <span className="hidden sm:inline">DM on Instagram for suggestions or corrections</span>
                  <span className="sm:hidden">Instagram</span>
                </div>
              </a>

              <a
                href="https://twitter.com/intent/post?text=Find%20Chhath%20Puja%20celebrations%20near%20you%20in%20Bengaluru!%0A%0AHere's%20beautiful%20community%20platform%20to%20connect%20with%20our%20traditions%20for%20those%20who%20couldn't%20go%20home%20%E2%9C%A8&url=https%3A%2F%2Fthechhathpuja.com%2F&hashtags=ChhathPuja,ChhathPujaInBengaluru"
                target="_blank"
                rel="noopener noreferrer"
                className="group relative inline-flex items-center space-x-2 px-3 py-1.5 bg-gray-800 hover:bg-gray-900 text-white text-xs rounded-full transition-colors duration-200"
              ...
              >
                ...
                <span>Share</span>
                <div className="absolute bottom-full mb-2 left-1/2 transform -translate-x-1/2 bg-gray-900 text-white text-xs px-2 py-1 rounded opacity-0 group-hover:opacity-100 transition-opacity duration-200 whitespace-nowrap pointer-events-none z-50">
                  <span className="hidden sm:inline">Tweet about Chhath celebrations</span>
