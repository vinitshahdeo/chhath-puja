      ...
      <section className="relative py-16 overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <h1 className="text-5xl sm:text-7xl font-display font-bold text-gray-900 mb-6">
            ...
            <br />
            <span className="text-3xl sm:text-4xl text-gray-700">The Voice of छठ पूजा</span>
          </h1>
      ...
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="max-w-5xl mx-auto">
            <div className="bg-gradient-to-r from-marigold-100 to-saffron-100 rounded-3xl p-6 shadow-xl">
              ...
              {[
                ...
                >
                  <div className="text-center mb-4">
                    <div className="w-16 h-16 bg-gradient-to-br from-marigold-400 to-saffron-500 rounded-full flex items-center justify-center mx-auto text-2xl mb-3 group-hover:animate-pulse">
                      {video.thumbnail}
                    </div>
                    <h4 className="font-semibold text-lg text-gray-900 mb-2">{video.title}</h4>
                    <p className="text-sm text-gray-500 mb-4">{video.views}</p>
                  </div>
                  ...
                  <a
                    ...
                    className="block w-full bg-gradient-to-r from-marigold-500 to-saffron-500 hover:from-marigold-600 hover:to-saffron-600 text-white font-semibold py-3 px-4 rounded-lg text-center transition-all duration-200 transform group-hover:scale-105"
                  >
